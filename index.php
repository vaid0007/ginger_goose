...
<link rel="stylesheet" href="assets/css/main.css" />
  ...
  <body>
    ...
    <main>
                    ...
                    <div class="col-xxl-8 col-lg-8">
                      <div class="banner-content-4">
                        ...
                        <div class="banner-btn-wrapper">
                          <a class="solid-btn" href="https://amzn.in/d/08Lxu9HO">
                            Shop Now
                            <span
      ...
      <section class="about-area section-space pb-0">
        <div class="container">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
              ...
              >
                <div class="about-thumb w-img">
                  <img src="assets/imgs/New/home_about.png" alt="" />
                </div>
                <div class="about-dot">
    ...
    <div class="about-content-6 wow fadeInRight animated" data-wow-delay="0.3s">
        <div class="section-title-wrapper-2 mb-15">
            <span class="section-subtitle-2 mb-15">ABOUT GINGER GOOSE</span>
        ...
        <p>
            Ginger Goose creates premium herbal wellness products inspired by the natural benefits of ginger. Our mission is to promote healthier lifestyles through safe, effective, and high-quality natural solutions.
        </p>

        <div class="features__list mb-40">
            <ul>
                <li>Premium Herbal Ingredients</li>
                <li>Natural Everyday Wellness</li>
                <li>Trusted Quality & Purity</li>
            </ul>
        </div>

        <p>
            We combine traditional herbal knowledge with modern innovation to deliver products that support comfort, vitality, and overall well-being.
        </p>
    </div>
</div>
          </div>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
              <div class="product-banner">
                <div
                  ...
                  data-background="assets/imgs/New/home_1.png"
                ></div>
              </div>
            </div>
          </div>
